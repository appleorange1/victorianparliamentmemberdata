...
class Popolo
  MODEL = {
    ...
    address:                     {
      aliases: %w(electorate_office_address_complete),
      type:                 'contact',
    },
    alternate_names:             {
    ...
    area:                        {
      aliases: %w(constituency region district place electorate),
    },
    area_id:                     {
      aliases: %w(constituency_id region_id district_id place_id electorate_id),
    },
    biography:                   {
      aliases: %w(bio blurb),
      type:    'asis',
    ...
    website:                     {
      type:                 'link',
      aliases:              %w(homepage href url site www),
